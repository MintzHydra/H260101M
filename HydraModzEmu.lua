...
--fitur e
godmode = MemoryPatch(targetLib, 0x1EAD2B8, "20008052")
godmode_ret = MemoryPatch(targetLib, 0x1EAD2BC, "C0035FD6")
alwayscrit = MemoryPatch(targetLib, 0x23D2318,"20008052")
alwayscrit_ret = MemoryPatch(targetLib, 0x23D231C, "C0035FD6")
aspd = MemoryPatch(targetLib, 0x20B0C78, "00C48952")
aspd_ret = MemoryPatch(targetLib, 0x20B0C7C, "C0035FD6")
stable = MemoryPatch(targetLib, 0x20AFCE0, "800C8052")
stable_ret = MemoryPatch(targetLib, 0x20AFCE4, "C0035FD6")
nograze = MemoryPatch(targetLib, 0x20BB5F8, "00008052")
noeva = MemoryPatch(targetLib, 0x20C7D4C, "00008052")
noguard = MemoryPatch(targetLib, 0x20C7D44, "00008052")
bosslowdef = MemoryPatch(targetLib, 0x20BB684, "800C8052")
bosslowmdef = MemoryPatch(targetLib, 0x20BB710, "800C8052")
highdef = MemoryPatch(targetLib, 0x20B0B7C, "00A38252")
highdef_ret = MemoryPatch(targetLib, 0x20B0B80, "C0035FD6")
highmdef = MemoryPatch(targetLib, 0x20B0BD0, "00A38252")
highmdef_ret = MemoryPatch(targetLib, 0x20B0BD4, "C0035FD6")
autoguard = MemoryPatch(targetLib, 0x1D15A40, "20008052")
autoguard_ret = MemoryPatch(targetLib, 0x1D15A44, "C0035FD6")
bigradius = MemoryPatch(targetLib, 0x20C7D6C, "E0E18452")
instantcast = MemoryPatch(targetLib, 0x20B4824, "00008052")
instantcast_ret = MemoryPatch(targetLib, 0x20B4828, "C0035FD6")
unlockboss = MemoryPatch(targetLib, 0x20DAD60, "E0E18452")
cutscene = MemoryPatch(targetLib, 0x1AB9940, "80008052")
nodomination = MemoryPatch(targetLib, 0x1C14618, "00008052")
nodomination_ret = MemoryPatch(targetLib, 0x1C1461C, "C0035FD6")
ailment100 = MemoryPatch(targetLib, 0x23DFD28, "20008052")
ailment100_ret = MemoryPatch(targetLib, 0x23DFD2C,"C0035FD6")
buffunli = MemoryPatch(targetLib, 0x20A9CA4, "00008052")
buffunl2 = MemoryPatch(targetLib, 0x20A9CB8, "00008052")
buffunl3 = MemoryPatch(targetLib, 0x20A9D3C, "1F2003D5")
cf1 = MemoryPatch(targetLib, 0x20AA184, "EA031E32")
cf2 = MemoryPatch(targetLib, 0x20AA558, "A0160011")
cf2 = MemoryPatch(targetLib, 0x20AA110, "1F2003D5")
mobinv = MemoryPatch(targetLib, 0x21A373C, "00008052")
mobinv_ret = MemoryPatch(targetLib, 0x21A3740, "C0035FD6")
fire = MemoryPatch(targetLib, 0x254A47C, "20008052")
water = MemoryPatch(targetLib, 0x254A47C, "40008052")
wind = MemoryPatch(targetLib, 0x254A47C, "60008052")
earth = MemoryPatch(targetLib, 0x254A47C, "80008052")
light = MemoryPatch(targetLib, 0x254A47C, "A0008052")
dark = MemoryPatch(targetLib, 0x254A47C, "C0008052")
neutral = MemoryPatch(targetLib, 0x254A47C, "E0008052")
nomove = MemoryPatch(targetLib, 0x20C7D94, "00008052")
nomove_ret = MemoryPatch(targetLib, 0x20C7D98, "C0035FD6")
instantfinal1 = MemoryPatch(targetLib, 0x1CEAB84, "08008052")
instantfinal2 = MemoryPatch(targetLib, 0x1CEAB88, "1F2003D5")
skillburst = MemoryPatch(targetLib, 0x1DB8AE4, "02E28452")
